...
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig001_quadrato.pgf}
\end{minipage}\vspace{5pt}

\begin{figure}[!htb]
\centering\input{./lbr/chap07/fig002_quadrato2.pgf}
...
\begin{figure}[!htb]
	\centering\input{./lbr/chap07/fig003_figure.pgf}
...
\begin{minipage}{0.4\textwidth}
	\centering\input{./lbr/chap07/fig004_figure2.pgf}
\end{minipage}\vspace{5pt}
...
\begin{figure}[!htb]
	\centering\input{./lbr/chap07/fig005_insiemi.pgf}
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap07/fig006_parallelogrammi_equiv.pgf}
\end{figure*}
...
\begin{minipage}{0.25\textwidth}
	\centering\input{./lbr/chap07/fig007_parallelogrammi_equiv1.pgf}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
	\centering\input{./lbr/chap07/fig008_parallelogrammi_equiv2.pgf}
\end{minipage}
\noindent\begin{minipage}{0.65\textwidth}\parindent15pt
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig009_parallelogrammi_equiv3.pgf}
\end{minipage}
\end{proof}
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap07/fig010_parallel_equiv_rett.pgf}
\end{figure*}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig011_parallel_equiv_rett1.pgf}
\end{minipage}\vspace{5pt}
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap07/fig012_tri_equiv_parall.pgf}
\end{figure*}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig013_tri_equiv_parall1.pgf}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig014_tri_equiv_parall2.pgf}
\end{minipage}\vspace{1pt}
\end{proof}
...
\begin{wrapfigure}{r}{0.6\textwidth}
	\centering\input{./lbr/chap07/fig015_tri_equiv_rett.pgf}
\end{wrapfigure}
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap07/fig016_trap_equiv_tri.pgf}
\end{figure*}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig017_trap_equiv_tri1.pgf}
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap07/fig018_pol_reg_equiv_tri.pgf}
\end{figure*}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{./lbr/chap07/fig019_pol_conv_lato.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{./lbr/chap07/fig020_pol_conv_lato2.pgf}
\end{wrapfigure}
\paragraph{Pentagono.}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{./lbr/chap07/fig021_tri_equiv.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.55\textwidth}
	\centering\input{./lbr/chap07/fig022_pol_conc.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig023_quad_equiv_pol.pgf}\vspace{6pt}\\
	\centering\input{./lbr/chap07/fig024_quad_equiv_pol2.pgf}\vspace{6pt}\\
	\centering\input{./lbr/chap07/fig025_quad_equiv_pol_es.pgf}
\end{wrapfigure}
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap07/fig026_area_rett.pgf}
\end{figure*}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{./lbr/chap07/fig027_parallelogramma.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{./lbr/chap07/fig028_rombo.pgf}
\end{wrapfigure}
...
\begin{minipage}{0.37\textwidth}
	\centering\input{./lbr/chap07/fig029_primo_teo_Euclide.pgf}
\end{minipage}\vspace{8pt}
...
\begin{minipage}{0.45\textwidth}
	\centering\input{./lbr/chap07/fig030_teo_Pitagora.pgf}
\end{minipage}\vspace{8pt}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{./lbr/chap07/fig031_secondo_teo_Euclide.pgf}
\end{minipage}\vspace{8pt}
...
\begin{figure*}
	\centering\input{./lbr/chap07/fig032_secondo_teo_Euclide_inv.pgf}
\end{figure*}
...
\begin{wrapfigure}{r}{0.25\textwidth}
	\centering\input{./lbr/chap07/fig033_tri_rett.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth}
	\centering\input{./lbr/chap07/fig034_tri_rett_45g.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth}
	\centering\input{./lbr/chap07/fig035_tri_rett_30_60g.pgf}
\end{wrapfigure}
...
\begin{figure}[!htb]
	\centering\input{./lbr/chap07/fig036_trap_iso_45g.pgf}\hspace{1cm}
	\input{./lbr/chap07/fig037_tri_iso_120g.pgf}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{./lbr/chap07/fig038_tri_gen_Erone.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{./lbr/chap07/fig039_tri_equi_inscr.pgf}
\end{wrapfigure}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig041_trap_circos.pgf}
\end{wrapfigure}
...
\begin{figure}[!htb]
	\begin{center}
		\begin{minipage}{0.45\textwidth}
			\centering
			\input{./lbr/chap07/fig042_trap_rett_circos.pgf}
...
\begin{figure*}[!htb]
	\centering
	\input{./lbr/chap07/fig044_trap_circos_semi.pgf}
\end{figure*}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap07/fig045_trap_circos_semi2.pgf}
\end{minipage}\vspace{8pt}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{./lbr/chap07/fig046_tri_circos.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{./lbr/chap07/fig047_tri_inscr.pgf}
\end{wrapfigure}
