...
\centering\input{./lbr/chap03/fig031_ese.pgf}
\end{minipage}
\end{esercizio}
...
\begin{figure}[htb]
\centering\input{./lbr/chap03/fig032_ese.pgf}
...
\centering\input{./lbr/chap03/fig033_ese.pgf}
\end{minipage}
\end{esercizio}
...
%\begin{figure}[htb]
\centering\input{./lbr/chap03/fig034_ese.pgf}
%\caption{Esercizio~\ref{ese:3.78}}\label{fig:ese3.78}
%\end{figure}
...
\centering\input{./lbr/chap03/fig035_ese.pgf}
\end{minipage}
\end{esercizio}
...
\centering\input{./lbr/chap03/fig036_ese.pgf}
\end{minipage}
\end{esercizio}
