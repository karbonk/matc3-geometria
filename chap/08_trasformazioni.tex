...
\begin{center}
 \noindent\begin{minipage}{0.4\textwidth}
    \centering\input{./lbr/chap08/fig001_es.pgf}
	\caption{Esempio~\ref{es:8.1}}\label{fig:es8.1a}
 \end{minipage}
 %\hspace{0.05\textwidth}
 \noindent\begin{minipage}{0.4\textwidth}
    \centering\input{./lbr/chap08/fig002_es.pgf}
...
\begin{figure}[!htb]
    \centering\input{./lbr/chap08/fig003_es.pgf}
...
\begin{center}
 ...
 \end{minipage}
 \noindent\begin{minipage}{0.49\textwidth}
    \centering\input{./lbr/chap08/fig005_es.pgf}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{./lbr/chap08/fig006_retta_unita.pgf}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{./lbr/chap08/fig007_retta_fissa.pgf}
\end{minipage}
...
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap08/fig008_simm_centr.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap08/fig010_simm_centr_rette_parall.pgf}
\end{minipage}\vspace{8pt}
...
\begin{wrapfigure}{r}{0.25\textwidth}
	\centering\input{./lbr/chap08/fig013_simm_ass.pgf}
\end{wrapfigure}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap08/fig014_simm_ass_iso.pgf}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{./lbr/chap08/fig015_simm_ass_rette.pgf}
\end{minipage}\vspace{5pt}
...
\begin{wrapfigure}{r}{0.35\textwidth}
	\centering\input{./lbr/chap08/fig016_simm_ass_triangolo.pgf}
\end{wrapfigure}
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap08/fig017_es_piano_cartes_simm_ass.pgf}
\end{figure*}
...
Generalizziamo: vogliamo determinare l'equazione della simmetria avente come asse una retta parallela all'asse $x$ di equazione $y=a$. Sia $P(x;y)$ un generico punto del piano e sia $P'(x';y')$ la sua immagine in $S_{y=a}$. Seguendo il ragionamento dell'esempio precedente possiamo scrivere: \[\valass{y-a} = \valass{y'-a}\]
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap08/fig018_es_piano_cartes_simm_ass2.pgf}
\end{figure*}
...
Generalizziamo: vogliamo determinare l'equazione della simmetria avente come asse una retta parallela all'asse $y$ di equazione $x=b$; sia $P(x;y)$ un generico punto del piano e sia $P'(x':y')$ la sua immagine in $S_{x=b}$. Seguendo il ragionamento dell'esempio possiamo scrivere \[\valass{x-b}=\valass{b-x'}\]
...
\begin{figure*}[!htb]
	\centering\input{./lbr/chap08/fig019_es_piano_cartes_simm_bisettr.pgf}
\end{figure*}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{./lbr/chap08/fig020_traslaz.pgf}
\end{wrapfigure}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.35\textwidth}
	\centering\input{./lbr/chap08/fig021_es_piano_cartes_trasl.pgf}
\end{wrapfigure}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{./lbr/chap08/fig022_rotazione.pgf}
\end{wrapfigure}
...
\begin{figure}[!htb]
	\centering\input{./lbr/chap08/fig023_rotazione2.pgf}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.25\textwidth}
	\centering\input{./lbr/chap08/fig024_rotazione3.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{./lbr/chap08/fig025_rotazione_iso.pgf}
\end{wrapfigure}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{./lbr/chap08/fig026_rotazione_iso_dir.pgf}
\end{wrapfigure}
...
\begin{figure}[!htb]
	\centering\input{./lbr/chap08/fig027_es_piano_cartes_comp.pgf}
...
%\begin{figure*}[!htb]
%	\centering\input{./lbr/chap08/fig029_es_piano_cartes_comp2.pgf}
%\end{figure*}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{./lbr/chap08/fig030_es_comp_iso.pgf}
\end{minipage}\vspace{5pt}
\end{exrig}
