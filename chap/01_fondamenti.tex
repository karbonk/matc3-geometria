...
%\includegraphics[scale=0.35]{\input{./lbr/chap01/fig029_figure.pgf}}
\input{./lbr/chap01/fig029_figure.pgf}
\end{wrapfloat}
Le figure a lato hanno la stessa forma ma una è più grande dell'altra, la seconda infatti è stata ottenuta dalla prima raddoppiando la lunghezza di ogni lato: in geometria tali figure si dicono \emph{simili}.
