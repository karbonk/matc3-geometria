...
\begin{figure}[bth]
 ...
 \centering
 \input{./lbr/chap01/fig004_assioma2.pgf}
 \caption{Assioma II}\label{fig:1.3}
 \end{minipage}
 \begin{minipage}[b]{.32\textwidth}
 \centering
 \input{./lbr/chap01/fig005_assioma3.pgf}
 \caption{Assioma III}\label{fig:1.4}
 \end{minipage}
 \begin{minipage}[b]{.32\textwidth}
 \centering
 \input{./lbr/chap01/fig006_assioma4.pgf}
...
\begin{figure}[htb]
 \centering
 \input{./lbr/chap01/fig007_assioma7.pgf}
...
\end{proof}
\begin{center}
\input{./lbr/chap01/fig010_teo_dens_retta.pgf}
\end{center}
\begin{definizione}
...
\begin{figure}[htb]
 ...
 \centering
 \input{./lbr/chap01/fig008_assioma12.pgf}
 \caption{Assioma XII}\label{fig:1.7}
 \end{minipage}
 \begin{minipage}[b]{.5\textwidth}
 \centering
 \input{./lbr/chap01/fig009_assioma14.pgf}
...
\begin{center}
 \input{./lbr/chap01/fig012_def_semiretta.pgf}
\end{center}
...
\end{definizione}
\begin{figure*}[bth]
\centering  \input{./lbr/chap01/fig013_def_angolo.pgf}
...
\begin{figure}[bth]
 \centering \input{./lbr/chap01/fig014_assioma15.pgf}
...
\begin{figure}[bth]
 \centering \input{./lbr/chap01/fig015_assioma17.pgf}
...
\begin{figure}[hbt]
 \centering \input{./lbr/chap01/fig016_tipi_rette.pgf}
...
\begin{figure}[!htb]
	\centering\input{./lbr/chap01/fig020_fascio_proprio_rette.pgf}
...
\begin{definizione}
Si chiama \emph{segmento} $AB$ l'insieme dei punti $A$ e $B$ e di tutti quelli della retta $AB$ che stanno tra $A$ e $B$.
...
\begin{figure}[bth]
 \centering \input{./lbr/chap01/fig017_segmento.pgf}
...
\end{definizione}
\begin{figure}[bth]
 \centering \input{./lbr/chap01/fig023_angolo_piatto_e_giro.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig042_somma_angoli.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig043_diff_angoli.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig044_mult_angolo.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig045_bisettrice.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig046_angolo_retto.pgf}
\end{figure}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig047_angoli_complementari.pgf}
\end{figure}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig048_angoli_supplementari.pgf}
\end{figure}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig049_angoli_esplementari.pgf}
\end{figure}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig050_ang_acuto_ottuso.pgf}
\end{figure}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig051_cong_opposti_al_vertice.pgf}
\end{figure}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig052_perpendicolari.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig053_distanza_P_retta.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig054_asse_segmento.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig055_misura_segmento_1.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig056_misura_segmento_2.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig057_diag_quadrato.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig058_misura_angolo.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig059_angolo_radianti.pgf}
...
\begin{figure}[!htb]
	\centering\input{./lbr/chap01/fig060_angoli_negativi.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig061_spezzata.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig062_spezzate.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig063_poligoni.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig064_angoli_poligoni.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig065_angoli_est.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap01/fig066_corda_diag.pgf}
...
\ovalbox{\risolvii \ref{ese:1.125}, \ref{ese:1.126}, \ref{ese:1.127}, \ref{ese:1.128}, \ref{ese:1.129}, \ref{ese:1.130}, \ref{ese:1.131}, \ref{ese:1.132}, \ref{ese:1.133}}
